            ...
            <div className="p-6 hover:-translate-y-1 transition-all">
              ...
              <ul className="pl-5 list-disc list-inside text-lg text-gray-300">
                <li>
                  <strong>
                    {" "}
                    <em>M.S. in Computer Engineerig </em>{" "}
                  </strong>
                  LIU University (2020-2025)
                </li>
            ...
            <ul className="pl-5 list-disc list-inside text-lg text-gray-300">
              <li>
                <strong className="text-blue-400">
                  <em>Frontend Developer (Freelance )</em>
                </strong>
                📍
                <br />* Remote | Jan 2024 - Present <br />
                - Built responsive and accessible websites using React.js,
                 and Tailwind CSS <br />- Developed dynamic user
                interfaces with JavaScript , HTML, and CSS. <br />
              </li>
              <li>
